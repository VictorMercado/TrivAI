...
type Presence = {
  host: boolean | null,
  // userData 
  cursor: { x: number, y: number, ratioX: number, ratioY: number } | null,
  ...
  // only for host to update
  hostData: {
    currentQuestionId: string | null,
    allAnswersCorrect: boolean | null,
    correctAnswer: string | null,
    everyoneHasAnswered: boolean | null,
    everyoneSlice: boolean | null,
    everyoneLoad: boolean | null,
    othersAnswers: Array<{
      userId: string,
...
type RoomEvent = {
  // type: "NOTIFICATION",
  type: "loading" | "slice" | "hasAnswered" | "allCorrect" | "oneCorrect" | "allCorrect" | "currentQuestion" | "results" | "notLoading" | "notHasAnswered",
  role: "host" | "user",
  data?: Array<{
    userId: string,
    selectedAnswer: string,
