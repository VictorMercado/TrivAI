        ...
        <td className="bg-transparent">
          {shouldAddRow || shouldDeleteRow ? (
            <span className="flex">
              <button
                title="Cancel"
                className="m-2 border border-red-500 p-2 hover:bg-red-500 hover:text-black"
              ...
              {shouldDeleteRow ? (
                <button
                  title="Save"
                  name={title}
                  className="m-2 border border-blue-500 p-2 hover:bg-blue-500 hover:text-black"
            ...
            <span className="flex items-center">
              <button
                title="Delete"
                className="m-2 border border-red-500 px-4 py-2 hover:bg-red-500 hover:text-black"
              ...
              <button
                ...
                className="m-2 border border-blue-500 px-4 py-2 hover:bg-blue-500 hover:text-black"
              ...
              {success && (
                <span
                  className={`m-2 border border-green-500 p-2 hover:bg-green-500`}
                  title={message}
                  onClick={() => {
                    setSuccess(false);
                    router.refresh();
              ...
              {error && (
                <span
                  className="m-2 border border-red-500 px-4 py-2 hover:bg-red-500"
                  title={message}
                  onClick={() => {
                    setError(false);
                    router.refresh();
