...
export default async function RootLayout({ children }: IProps) {
  ...
  return (
    <html
      className={shareTechMono.className + " coolBackground flex min-h-screen"}
      lang="en"
    >
      {/*
      ...
      */}
      <head />
      <body className="flex w-screen grow flex-col text-textBase" data-atr="this is the body">
        <ClientAppWrapper
          session={session}
        ...
        >
          {/* <ClientDimensions /> */}
          <Nav user={dbUser} />
          <div className="flex grow flex-col justify-between lg:flex-row lg:justify-start">
            <div className="fixed bottom-0 left-0 z-50 order-last flex w-screen justify-center border-r border-primary/25 bg-background pb-5 lg:static lg:order-first lg:w-24 lg:items-start">
              <SiteNav />
            </div>
