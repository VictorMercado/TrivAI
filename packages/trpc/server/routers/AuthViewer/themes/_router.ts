...
import { TCreateThemeInput, ZCreateThemeInput } from './create.schema';
import { publicProcedure } from '@trivai/trpc/server/trpc';
...
export const themeRouter = router({
  ...
  create: protectedProcedure.input(ZCreateThemeInput).mutation(async ({ ctx, input }) => {
